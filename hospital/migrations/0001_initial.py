# Generated by Django 2.0.4 on 2018-05-07 08:48
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Application',
            fields=[
                ('_id', models.UUIDField(default=uuid.uuid4, primary_key=True, serialize=False, verbose_name='ID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('field_type', models.IntegerField(choices=[(1, 'Integer'), (2, 'String')], verbose_name='Type')),
            ],
            options={
